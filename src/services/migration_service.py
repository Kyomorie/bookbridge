...
class MigrationService:
            ...
            with self.database_service.get_session() as session:
                for map_file in files:
                    ...
                    try:
                        ...
                        logger.error(f"❌ Failed to migrate '{map_file.name}': {e}", exc_info=True)
        ...
        try:
            ...
            if count > 0:
                ...
                try:
                    ...
                    logger.warning(f"⚠️ Failed to rename legacy cache file: {e}", exc_info=True)
        ...
        for fname in legacy_files:
            ...
            if fpath.exists():
                try:
                    ...
                    logger.warning(f"⚠️ Failed to cleanup '{fname}': {e}", exc_info=True)
    ...
    def _delete_legacy_file(self, file_path: Path):
        ...
        try:
            ...
            logger.warning(f"⚠️ Failed to delete legacy file '{file_path.name}': {e}", exc_info=True)
